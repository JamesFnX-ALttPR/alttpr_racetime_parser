...
<html>
	...
	<body>
		<div class="topline"><a href="<?= $domain ?>">Home</a><a href="<?= $domain ?>/featured">Featured Modes</a><a href="<?= $domain ?>/asyncs">Custom Asyncs</a><a href="<?= $domain ?>/discord" target="_blank">Discord</a></div>
		<br><br><hr>
